    ...
    <Fragment>
      <div className="container-fluid">
        <div id="about-top">
          ...
          <div id="about-image">
            <img className="img-fluid max-width:100% pb-2" src={"/imgs/about-slider.png"} alt="aboutimage" />
          </div>
        </div>
        <div className="about"> 
        <br/>
       ...
       <br/>
        <p id="about-message">
          ...
          legal representation.<br/><br/>We provide civil and criminal legal aid and
          ...
          access to justice.<br/><br/> <b>Talk to us on +256 784414719/ +256 706142727 or
